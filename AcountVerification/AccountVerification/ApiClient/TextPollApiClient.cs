...
namespace AccountVerification.ApiClient
{
    public class TextPollApiClient
    {
        ...
        public static CreateSingleImagePollRequest CreateSingleImagePoll(CreateSingleImagePollRequest requestObj)
        {
        ...
        public static BestImagePoll CreateBestImagePoll(BestImagePoll requestObj)
        {
